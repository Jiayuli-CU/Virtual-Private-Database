...
(
  ...
  STATUS VARCHAR2(10) CHECK (STATUS IN ('completed', 'ongoing', 'waiting')) NOT NULL,
...
(
  ...
  PROJECT_ID INT NOT NULL,
  EMPLOYEE_ID VARCHAR2(20) NOT NULL,
  GROUP_TYPE VARCHAR2(20) CHECK (GROUP_TYPE IN ('traditional', 'new')) NOT NULL,
  CONTENT VARCHAR2(2000) NOT NULL, 
  PICTURE CLOB,
  UPDATE_TIME DATE NOT NULL, 
  STATUS VARCHAR2(10) CHECK (STATUS IN ('completed', 'ongoing')) NOT NULL,
