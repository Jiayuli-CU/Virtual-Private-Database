...
REVOKE ALL ON databases FROM SDE_BE_1;
REVOKE ALL ON databases FROM SDE_BE_2;
REVOKE ALL ON databases FROM SDE_BE_3;
REVOKE ALL ON databases FROM SDE_FE_1;
REVOKE ALL ON databases FROM SDE_FE_2;
REVOKE ALL ON databases FROM SDE_FE_3;
REVOKE ALL ON databases FROM SDE_TE_1;
REVOKE ALL ON databases FROM SDE_TE_2;
REVOKE ALL ON databases FROM SDE_TE_3;
